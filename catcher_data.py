...
batter_data = pd.read_csv(parent_directory / "data/catcher_data.csv")
...
merged_data = batter_data.merge(id_data, left_on="fielder_2", right_on="mlbID")
...
# dataframe["League"] = dataframe["Lev"].apply(lambda x: x.split("-")[1])
...
# Wrap labels at e.g., 10 characters per line
labels = [
...
ax.set(
    title="[Mets Catchers]: Win Percentage Added/Lost",
    ylabel="Catcher",
